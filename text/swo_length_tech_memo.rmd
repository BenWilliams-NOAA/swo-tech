...
The overall workload on board of survey vessels, which included determining sex for each individual in the length frequency sub-samples (e.g., upwards of 200 per tow per species), has likely led to unacceptable numbers of acute and repetitive stress injuries of survey staff.
...
$E_{h,st,y}$ is computed as the net width multiplied by the distance fished of the tow, or, the area swept by the haul (in km^2^).
